...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__NZBNService__ = __webpack_require__(3);



__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function ($) {
  var $lists = $('.js-nzbn-list');
  var service = new __WEBPACK_IMPORTED_MODULE_1__NZBNService__["a" /* default */]();
  ...
  $('.nzbn-lookup').each(function () {
    ...
    var $button = $this.find('.js-nzbn-button');
    var $list = $this.find('.js-nzbn-list');

    $button.on('click', function (e) {
      e.preventDefault();

      var $this = $(this);
      var $container = $this.closest('.nzbn-lookup');
    ...
    $list.on('click', '.nzbn-item', function () {
      var $this = $(this);
      var nzbn = $this.data('nzbn');
      var fieldMap = $input.data('nzbn');
      var value = $this.text();
      ...
      service.get(nzbn).then(function (data) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = NZBNService;
function NZBNService() {
...
NZBNService.prototype.get = function (nzbn) {
  var url = this.baseURL + '?NZBN=' + nzbn;
  var request = new Request(url, { headers: this.headers });
